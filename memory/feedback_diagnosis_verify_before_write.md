...
**心態:** 求真姿態，不信印象。「我記得是這樣」「應該是這樣」「之前看過」全是紅旗 — 寫架構診斷影響範圍很大，每條現狀描述都要有 file:line 證據。漂亮但錯誤的診斷比沒診斷更危險，因為它把錯前提傳給下一個動手的人。
...
- 驗證+1:2026-08-06 第2場 — agent 報告說 macs 記憶有 Cloudflare token，現場驗證後只是省略形式，我上一輪的轉述誇大了，當場更正

- 驗證+1:2026-08-07 第3場 — 三次錯（nova-2/barge-in TODO/LLM 三選一）全因讀說明不讀本體，逐一讀 code 更正並寫進報告誠實章
