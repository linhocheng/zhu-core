...
- 驗證+1:2026-08-05 第3場 — 「重簽＝重種」是「重簽必然全表改動」年代的假設，V3 押回流程讓它過期

- 驗證+1:2026-08-05 第6場 — COST_MODEL 每個數字附重驗觸發；timeout 前提「6字單帳號」變則重算

- 驗證+1:2026-08-08 第5場 — `limit(100)` 是「當時池子還沒滿 100」的快照，這場正是它到期爆開

- 驗證+1:2026-08-08 第6場 — MiniMax emotion 合法值不憑記憶，實打 API 驗（fear/surprise 我以為對其實被拒）
