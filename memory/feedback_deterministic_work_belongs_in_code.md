...
- 驗證+1:2026-08-04 第3場 — 訂單號正規化/欄位解析全用程式不丟 LLM
...
- 驗證+1:2026-08-08 第3場 — 標記剝除/砍鏡手術/幀重掛全走程式；契約與行為分層

- 驗證+1:2026-08-08 第7場 — 帳本累加/左右分側/幀引用全走程式；帳本刻意不落庫（純函數視圖）避免真相分裂

- 驗證+1:2026-08-09 第1場 — 情緒標解析/序列化全程式＋10 測試向量，LLM 只管產標
