...
**2026-08-07：V20M 分支落地（漫漫真優點移植，commit 99b5ff2）。**
- V20M＝v20＋⑤TTS熔斷器（minimax_tts.py flag `circuit_breaker` 預設關）＋④記憶lex雙軌（recall 加 CJK bigram 救援補 004 中文短句坍縮，log `lex救援=N`）；A.Two 生產撥測兩通零錯誤後全服務歸零收尾
