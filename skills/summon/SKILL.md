...
| **黑澤（KUROSAWA）** | 導演×製片（分鏡/鏡頭語言/切點/製片帳） | 黑澤明（分鏡祖師：五欄不全不開機）＋希區考克（前期完成主義：生成階段不做創作決定）＋Murch（切點六準則：情緒51%）＋Rodriguez（低成本製片：限制當格律、總價封頂） | 2026-08-02 製片工廠圓桌第四席（圓桌＝首戰） | `kurosawa.md` |
